---
title: "Estrategias de Chunking: El cuello de botella silencioso"
subtitle: "Lección 2 — Pilar 1: Ingesta y Segmentación"
pillar: ingesta
pillarName: "Ingesta"
lessonNum: 2
description: "El dilema chunk-size, 4 estrategias de chunking, Contextual Retrieval de Anthropic (-49% fallos), benchmarkVecta 2026."
keywords: "chunking, chunk size, contextual retrieval, embeddings, RAG, LangChain"
ogSection: "Ingesta"
pubDate: "2026-07-24"
quizzes:
  - id: "q1"
...
<Callout type="info" title="Dato clave de producción">
El tamaño de chunk mueve las métricas más que la elección del algoritmo. En benchmarks de 2026, la diferencia entre 256 y 512 tokens fue mayor que la diferencia entre recursive y semantic chunking.
<small>Fuente: Vecta Benchmark (Feb 2026) — 7 estrategias, 50 papers academicos</small>
</Callout>
...
<Callout type="success" title="El default de producción 2026">
`chunk_size=512`, `chunk_overlap=64`, separadores en orden: párrafo → línea → oración → palabra. En benchmarks de 50 papers académicos, recursive 512 obtuvo 69% de accuracy vs 54% de semantic chunking.
<small>Fuente: Vecta Benchmark (Feb 2026) — Recursive 512: 69% accuracy, Semantic: 54% accuracy</small>
</Callout>
...
<Callout type="warning" title="Problema conocido con defaults">
LangChain's `SemanticChunker` con threshold al percentil 95 produce chunks de solo 43 tokens en promedio en textos académicos. Casi siempre necesitas subir el threshold a 99 o ajustar el `min_chunk_size`.
</Callout>
...
<Callout type="success" title="Impacto medido">
Parent-child retrieval mejora típicamente: +10-20% en faithfulness, +5-15% en answer relevance. La ganancia en faithfulness es la más grande porque el LLM no necesita "adivinar" el contexto faltante.
</Callout>
...
<small>Fuente: Anthropic Engineering Blog — Contextual Retrieval (Sep 2024)</small>
...
<Exercise title="Ejercicio 1: Analiza el chunking del repo">
Abre `chapter2/parse-pdf.ipynb` del repositorio hands-on-rag. Identifica:

- ¿Qué tamaño de chunk se usa?
- ¿Qué estrategia de división?
- ¿Qué overlap se configuró?
</Exercise>

<Exercise title="Ejercicio 2: Implementa parent-child">
Usando el código del Capítulo 2 como base, modifica el pipeline para usar parent-child chunking:

- Child chunks: 250 tokens
- Parent chunks: 1500 tokens
- Embedda solo los children
- Al recuperar, retorna el parent

**Pista:** Mira `ParentDocumentRetriever` de LangChain.
</Exercise>

<Exercise title="Ejercicio 3: Compara estrategias">
Crea un mini-eval con 5 preguntas sobre el documento del Capítulo 1 (Alice in Wonderland). Ejecuta el pipeline 3 veces:

- Recursive 512 sin overlap
- Recursive 512 con overlap 64
- Semantic chunking (percentil 95)

Compara: ¿cuántos de los top-3 chunks contienen la respuesta correcta?
</Exercise>
